...
?>
	<div id="content">
		<h2>Genes list</h2>
		<p>This page show all the genes in the genome <?php echo $site_name ?>, ordered by their position. The right-hand column lists the breaks in which a gene may be found against one or several other genomes.</p>
